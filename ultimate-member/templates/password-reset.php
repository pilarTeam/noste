	...
	<div class="um-form">
		<form method="post" action="">
			<?php if ( isset( $_GET['updated'] ) && 'checkemail' === sanitize_key( $_GET['updated'] ) ) { ?>
				<div class="noste-reset-updated text-center">
					<img class="w-20 m-auto" src="<?php echo get_template_directory_uri() . '/assets/images/email-icon.svg'; ?>">
					<h2 class="text-lg leading-8 pt-10 pb-6">Olemme lähettäneet sinulle sähköpostin, jossa on linkki salasanan nollaukseen.</h2>
					<p class="text-lightGray">Tarkista roskaposti- ja tarjoukset-kansiot, jos viesti ei näy pääpostilaatikossasi.</p>
					<a href="/login/?updated=" class="block text-ancent pt-9 font-bold">Et saanut sähköpostia?</a>
				</div>
			...
			<?php } else { ?>
				...
				<?php } else { ?>
					<div class="noste-reset-label"><label>Sähköpostiosoite</label></div>
				<?php }
