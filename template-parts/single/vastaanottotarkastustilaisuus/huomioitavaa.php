...
>
                            ...
                            <div class="max-w-[700px] mx-auto">
                                ...
                                <div class="flex gap-2 mb-10">
                                    ...
                                    <div class="flex gap-3">
                                        <input type="text" name="rakennutta_15_input" class="w-full shadow-[0_0_5px_2px_rgb(81,244,200,44%)] border border-solid border-[#06F9B7] rounded-[5px] p-2" value="<?php echo esc_attr( noste_check_array_data( $data, 'rakennutta_15_input' ) ); ?>">
                                    </div>
                                </div>
                            ...
                            <div class="max-w-[700px] mx-auto mb-10">
                                ...
                                <div>
                                    ...
                                    <label class="inline-flex items-center gap-2 cursor-pointer mb-10">
                                        ...
                                        <input type="text" name="vakuudet_26_ext_value" class="w-[350px] shadow-[0_0_5px_2px_rgb(81,244,200,44%)] border border-solid border-[#06F9B7] rounded-[5px] p-2" value="<?php echo esc_attr( noste_check_array_data( $data, 'vakuudet_26_ext_value' ) ); ?>">
                                    </label>
                                </div>
