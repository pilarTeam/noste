...
<section class="py-10">
    ...
    <div class="grid grid-cols-1 gap-4">
        <div class="container">
            ...
            <!-- card_item -->
            <?php echo wp_kses_post(noste_form_header('form')); ?>
            <!-- Card Header -->
                <!-- Card Body -->
                            ...
                            <div class="help_wrap my-10 relative">
                                <div class="max-w-[700px] mx-auto">
                                    <div class="flex flex-col lg:flex-row lg:items-center gap-2">
                                        <input type="text" name="yleista" class="shadow-input inline-block max-w-full w-full border border-solid border-[#06F9B7] rounded-[5px] p-2" value="<?php echo esc_attr( noste_check_array_data( $data, 'yleista' ) ); ?>">
                            ...
                            <div class="max-w-[700px] mx-auto flex items-center gap-2">
                                <ul class="list-none w-full">
                                    ...
                                    <li class="mb-10">
                                        ...
                                        <textarea class="shadow-input inline-block max-w-full w-full border border-solid border-[#06F9B7] rounded-[5px] p-4" id="tilajako-osat" name="tilajako-osat" rows="22">
                                            <?php echo htmlspecialchars( noste_check_array_data( $data, 'tilajako-osat' ) ); ?>
                                        </textarea>
                                    </li>
