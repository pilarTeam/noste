...
<<<<<<< HEAD
                                                ...
                                                <p class="italic text-[#00B2A9]">U4</p>
                                            </div>
                                        </div>
                                        <p class="italic text-[#00B2A9] mr-4">U1</p>
=======
...
<<<<<<< HEAD
                                                    <input type="checkbox" class="checkbox_change absolute opacity-0 cursor-pointer" name="pilar_K17" />
                                                    <p class="italic text-[#00B2A9]">U7</p>
                                                </div>
                                            </div>
                                            <p class="italic text-[#00B2A9] mr-4">U1</p>
=======
...
<<<<<<< HEAD
                                                    <input type="checkbox" class="checkbox_change absolute opacity-0 cursor-pointer" name="pilar_K17" />
                                                    <p class="italic text-[#00B2A9]">T10</p>
                                                </div>
                                            </div>
                                            <p class="italic text-[#00B2A9] mr-4">T9</p>
=======
...
<<<<<<< HEAD
                                                    <input type="checkbox" class="checkbox_change absolute opacity-0 cursor-pointer" name="pilar_K17" />
                                                    <p class="italic text-[#00B2A9]">K6</p>
                                                </div>
                                            </div>
                                            <p class="italic text-[#00B2A9] mr-4">K22</p>
=======
...
<<<<<<< HEAD
                                            ...
                                            <p class="italic text-[#00B2A9] mr-4">T2</p>
=======
...
<<<<<<< HEAD
                                                    <input type="checkbox" class="checkbox_change absolute opacity-0 cursor-pointer" name="pilar_K17" />
                                                    <p class="italic text-[#00B2A9]">P1</p>
=======
...
<<<<<<< HEAD
                                                    <input type="checkbox" class="checkbox_change absolute opacity-0 cursor-pointer" name="pilar_K17" />
                                                    <p class="italic text-[#00B2A9]">P4</p>
=======
...
<<<<<<< HEAD
                                    <p class="text-accent italic font-medium">T1</p>
=======
...
<<<<<<< HEAD
                                    ...
                                    <p><span class="italic text-[#00B2A9]">P1, </span>puh. <span class="italic text-[#00B2A9]">P2</span></p>
=======
...
<<<<<<< HEAD
                                    ...
                                    <p><span class="italic text-[#00B2A9]">P4, </span>puh. <span class="italic text-[#00B2A9]">P5</span></p>
=======
...
<<<<<<< HEAD
                                    <p class="text-accent italic font-medium">U1</p>
=======
...
<<<<<<< HEAD
                                    <p><span class="italic text-[#00B2A9]">U7, </span>puh. <span class="italic text-[#00B2A9]">U9</span></p>
=======
...
<<<<<<< HEAD
                                    <p class="text-accent italic font-medium">T9</p>
=======
...
<<<<<<< HEAD
                                    ...
                                    <p class="text-[#586B74]"><span class="italic text-[#00B2A9]">T10, </span>puh. <span class="italic text-[#00B2A9]">T11</span></p>
=======
...
<<<<<<< HEAD
                                    <p class="text-accent italic font-medium">K22</p>
=======
...
<<<<<<< HEAD
                                    ...
                                    <p class="text-[#586B74]"><span class="italic text-[#00B2A9]">K6, </span>puh. <span class="italic text-[#00B2A9]">K10</span></p>
=======
...
>>>>>>> ab13571eacaddea1c130c975b10737a39efd6106
                                ...
                                <div class="flex md:flex-row flex-wrap gap-5 mt-7 text-[#283B44]">
                                    ...
                                    <div>
<<<<<<< HEAD
                                        <p class="text-accent italic font-medium">K23</p>
                                        <p class="mt-6 text-[#586B74]">
                                            <span class="italic text-[#00B2A9]">K11, </span>puh.
                                            <span class="italic text-[#00B2A9]">K13</span>
=======
...
<<<<<<< HEAD
                                    <p class="text-[#586B74]">Aukioloajat klo <span class="text-accent italic">K16</span></p>
=======
...
<<<<<<< HEAD
                                ...
                                <div class="mt-14 text-[#586B74]">
                                    <div class="max-w-[850px] mx-auto">
                                        ...
                                        <div class="flex lg:gap-[60px] gap-[20px] mt-6">
                                            <p>-</p>
                                            <p>Pääurakoitsijana toimiva <span class="text-[#00B2A9] italic">U1</span> vastaa työmaan johtovelvollisuuksista ja toimii lainsäädännön tarkoittamana</p>
                                        </div>
                                        ...
                                        <div class="flex md:items-center lg:flex-row mt-[26px] max-w-[850px] mx-auto">
                                            <div class="flex md:items-center lg:gap-[60px] gap-[20px] md:min-w-[320px] min-w-[230px]">
                                                ...
                                                <div class="flex md:items-center">
                                                    ...
                                                    <input type="checkbox" class="checkbox_change lg:absolute opacity-0 cursor-pointer" name="pilar_K17" />
                                                    <p class="ml-2 text-[#586B74] mr-[13px]">TMK1: Työnjohtajana toimii <span class="text-[#00B2A9] italic">U7</span></p>
                                                </div>
                                            </div>
                                            <a href="#!" class="help_click mt-[6px] md:mt-[0px]">
                                                <svg width="18px" height="18px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="max-w-[850px] mx-auto">
                                        ...
                                        <div class="mt-[18px]">
                                            ...
                                            <div class="flex items-center md:flex-row mt-[18px] relative">
                                                ...
                                                <input class="border w-full h-8 shadow-[0_0_5px_2px_rgb(81,244,200,44%)] rounded-md border-[#06F9B7] py-[10px] text-[#283B44] ml-5 font-medium" value="Vapaa teksti" type="text" name="" id="" />
                                            </div>
                                        </div>
                                    ...
                                    <input
                                    class="border lg:min-w-[658px] md:min-w-[500px] min-w-[70px] h-8 shadow-[0_0_5px_2px_rgb(81,244,200,44%)] rounded-md border-[#06F9B7] py-[10px] text-[#283B44] mr-3 ml-2 font-medium"
                                    ...
                                    <hr class="help_line hidden w-full my-2 lg:my-0 border border-solid border-[#E1E1EA]" />
                                        ...
                                        <div class="help_show hidden text-[#586B74] text-[14px] lg:w-[254px] bg-[#F6F8FF] border border-solid border-[#E1E1EA] rounded-lg p-4 lg:absolute lg:right-[0px] lg:mt-[-50px] mt-[10px] mb-[15px] lg:mb[0]" >
...
<<<<<<< HEAD
                                ...
                                <div class="max-w-[850px] mx-auto text-[#586B74] mt-14">
                                    ...
                                    <div class="flex items-center lg:flex-row mt-[18px] relative">
                                        ...
                                        <input class="border max-w-[660px] w-full h-full shadow-[0_0_5px_2px_rgb(81,244,200,44%)] rounded-md border-[#06F9B7] py-[10px] text-[#283B44] ml-5 font-medium" value="Vapaa teksti" type="text" name="" id="" />
                                    </div>
                                ...
                                <div class="max-w-[850px] mx-auto text-[#586B74] mt-14">
                                    ...
                                    <div class="flex items-center mt-8 relative ml-[20px] lg:ml-[0px]">
                                        ...
                                        <input type="checkbox" class="checkbox_change lg:absolute opacity-0 cursor-pointer" name="pilar_K17" />
                                        <input class="border max-w-[660px] w-full h-8 shadow-[0_0_5px_2px_rgb(81,244,200,44%)] rounded-md border-[#06F9B7] py-[10px] text-[#283B44] mx-3 font-medium" value="Aihe" type="text" name="" id="" />
                                    </div>
                                    ...
                                    <div class="flex items-center lg:flex-row mt-[18px] relative">
                                        ...
                                        <input class="border max-w-[601px] w-full h-8 shadow-[0_0_5px_2px_rgb(81,244,200,44%)] rounded-md border-[#06F9B7] py-[10px] text-[#283B44] ml-5 font-medium" value="Vapaa teksti" type="text" name="" id="" />
                                    </div>
                                </div>
                                <!-- step 10 end -->
                                ...
                                <div class="max-w-[850px] mx-auto text-[#586B74] mt-14">
                                    ...
                                    <p class="mt-6">Urakoitsijan on kiinnitettävä huomiota, ettei meluavia töitä suoriteta arkisin klo <span class="text-[#FE3B2D]">K7</span> välisenä aikana.</p>
                                ...
                                <div class="max-w-[850px] mx-auto text-[#586B74] mt-14">
                                    ...
                                    <p class="mt-6">Urakoitsijan on kiinnitettävä huomiota, ettei meluavia töitä suoriteta arkisin klo <span class="text-[#00B2A9] italic">K7</span> välisenä aikana.</p>
                                </div>
...
<<<<<<< HEAD
                                        ...
                                        <input class="border lg:min-w-[660px] md:min-w-[560px] max-w-[173px] h-8 shadow-[0_0_5px_2px_rgb(81,244,200,44%)] rounded-md border-[#06F9B7] py-[10px] text-[#283B44] mx-3 font-medium" value="Vapaa teksti" type="text" name="" id="" />
=======
...
<<<<<<< HEAD
                                            ...
                                            <div class="col-span-1">
                                                <div class="border-b-2 w-full text-[#94969C] md:block hidden mb-6"></div>
                                                    ...
                                                    <p class="text-[#00B2A9] italic">U1</p>
                                            </div>
                                        </div>
...
<<<<<<< HEAD
                                        ...
                                        <div class="flex flex-wrap items-center mt-4">
                                            ...
                                            <input class="border lg:max-w-[601px] md:max-w-[500px] w-full h-8 shadow-[0_0_5px_2px_rgb(81,244,200,44%)] rounded-md border-[#06F9B7] py-[10px] text-[#283B44] lg:ml-5 mt-[12px] lg:mt-[0px] font-medium" value="Vapaa teksti" type="text" name="" id="" />
                                    </div>
                                </div>
