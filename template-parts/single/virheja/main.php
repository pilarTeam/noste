<?php 
    ...
    $tm_inner = [
        'koordinoi-virhe' => [
            ...
            'status' => !empty($project_intdata['koordinoi-virhe']['status']) ? $project_intdata['koordinoi-virhe']['status'] : 0,
            'url' => '',
            'comment' => !empty($project_intdata['koordinoi-virhe']['comment']) ? $project_intdata['koordinoi-virhe']['comment'] : '',
        ],
        'varmista' => [
        ...
        <div class="grid grid-cols-1">
            ...
            <div class="card_item relative h-fit">
                ...
                <div class="px-4 md:px-8 pt-6 pb-10 lg:h-[645px] overflow-y-auto no-scrollbar scroll-smooth">
                    <h1 class="text-2xl text-dark mb-4">Virhe- ja puutekorjausten valvonta</h1>
