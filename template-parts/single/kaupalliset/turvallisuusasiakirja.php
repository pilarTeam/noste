                ...
                <form action="<?php echo esc_url( get_permalink( get_the_ID() ) ); ?>" method="post" enctype="multipart/form-data" class="ajax-submit">
                    ...
                    <div class="px-4 md:px-8 pt-6 pb-10 lg:h-[645px] overflow-y-auto no-scrollbar scroll-smooth">
                        ...
                        <div class="max-w-[700px] mx-auto mt-20">
                            ...
                            <div class="mb-[30px]">
                                ...
                                <div class="flex items-center mb-5">
                                    <span class="text-[#586B74] text-[17px] w-[15%]">Versio:</span>
                                ...
                                <div class="flex items-center mb-5">
                                    <span class="text-[#586B74] text-[17px] w-[15%]">Tilaaja:</span>
                                    <span class="text-[#00B2A9] italic">T1</span>
                                </div>
                                <div class="flex items-center mb-5">
                                    <span class="text-[#586B74] text-[17px] w-[15%]">Laatija:</span>
                                    <span class="text-[#586B74] text-[15px]">
                                        <span class="text-[#00B2A9] italic">P1</span> , Partners at Noste Oy
                                    </span>
                                </div>
                                <div class="flex items-center mb-5">
                                    <span class="text-[#586B74] text-[17px] w-[15%]">Tilaaja:</span>
                                ...
                                <div class="flex items-center mb-5">
                                    <span class="text-[#586B74] text-[17px] w-[15%]"></span>
                                    <span class="text-[#00B2A9] italic">K1</span>
                                </div>
                                <div class="flex items-center mb-5">
                                    <span class="text-[#586B74] text-[17px] w-[15%]"></span>
                                    <span class="text-[#00B2A9] italic">K2</span>
                                </div>
                                <div class="flex items-center mb-5">
                                    <span class="text-[#586B74] text-[17px] w-[15%]"></span>
                                    <span class="text-[#00B2A9] italic">K3</span>
                                </div>
                            </div>
                            ...
                            <div class="mt-10">
                                ...
                                <div class="flex items-center mb-10">
                                    <span class="text-[#586B74] text-[17px] w-[35%]">Rakennuskohteen kuvaus:</span>
                                    
                                    <div class="help_wrap relative">
                                        <div class="flex items-center gap-2">
                                            <span class="text-[#586B74] text-[17px]">Rakennushanke käsittää</span>
                                            <span class="text-[#586B74]">
                                                <input type="text" name="pilar_VA1" placeholder="" class="w-full lg:w-[209px] shadow-[0_0_5px_2px_rgb(81,244,200,44%)]  border border-solid border-[#06F9B7] rounded-[5px] p-2">
                                            </span>
                                ...
                                <div class="flex items-center mb-5">
                                    <span class="text-[#586B74] text-[17px] w-[35%]"></span>
                                    
                                    <div class="help_wrap relative">
                                        <div class="flex items-center gap-2">
                                            <span class="text-[#586B74] text-[17px]">
                                        ...
                                        <div class="help_show text-[#586B74] text-[14px] lg:w-[180px] 2xl:w-[350px] bg-[#F6F8FF] border border-solid border-[#E1E1EA] rounded-lg p-5 lg:absolute lg:ml-[50px] lg:left-[100%] mt-[10px] mb-[15px] lg:mb[0] lg:mt-[-55px] hidden">
                                    ...
                                    <div>
                                        <div class="flex items-center gap-3 mb-3">
                                            <label class="inline-flex items-center gap-2 cursor-pointer">
                                                ...
                                                <span class="text-[#586B74]">Purkutöitä</span>
                                            </label>
                                        </div>
                                        <div class="flex items-center gap-3 mb-3">
                                            <label class="inline-flex items-center gap-2 cursor-pointer">
                                                ...
                                                <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                                <span class="text-[#586B74]">Haitta-ainepurkuja</span>
                                            </label>
                                        </div>
                                        <div class="flex items-center gap-3 mb-3">
                                            <label class="inline-flex items-center gap-2 cursor-pointer">
                                                ...
                                                <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                                <span class="text-[#586B74]">Tasoitus- ja maalaustöitä</span>
                                            </label>
                                        </div>
                                        <div class="flex items-center gap-3 mb-3">
                                            <label class="inline-flex items-center gap-2 cursor-pointer">
                                                ...
                                                <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                                <span class="text-[#586B74]">Uusien kipsilevyseinien rakennustyötä</span>
                                            </label>
                                        </div>
                                        <div class="flex items-center gap-3 mb-3">
                                            <label class="inline-flex items-center gap-2 cursor-pointer">
                                                ...
                                                <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                                <span class="text-[#586B74]">Lasiseinien asennusta</span>
                                            </label>
                                        </div>
                                        <div class="flex items-center gap-3 mb-3">
                                            <label class="inline-flex items-center gap-2 cursor-pointer">
                                                ...
                                                <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                                <span class="text-[#586B74]">Uuden lattiamateriaalin asennusta</span>
                                            </label>
                                        </div>
                                        <div class="flex items-center gap-3 mb-3">
                                            <label class="inline-flex items-center gap-2 cursor-pointer">
                                                ...
                                                <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                                <span class="text-[#586B74]">Alakatto- tai holvitöitä</span>
                                            </label>
                                        </div>
                                        <div class="flex items-center gap-3 mb-3">
                                            <label class="inline-flex items-center gap-2 cursor-pointer">
                                                ...
                                                <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                                <span class="text-[#586B74]">Keittiökalusteasennuksia</span>
                                            </label>
                                        </div>
                                        <div class="flex items-center gap-3 mb-3">
                                            <label class="inline-flex items-center gap-2 cursor-pointer">
                                                ...
                                                <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                                <span class="text-[#586B74]">WC:n rakennustöitä</span>
                                            </label>
                                        </div>
                                        <div class="flex items-center gap-3 mb-3">
                                            <label class="inline-flex items-center gap-2 cursor-pointer">
                                                ...
                                                <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                                <span class="text-[#586B74]">Märkätilatöitä</span>
                                            </label>
                                        </div>
                                        <div class="flex items-center gap-3 mb-3">
                                            <label class="inline-flex items-center gap-2 cursor-pointer">
                                                ...
                                                <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                                <span class="text-[#586B74]">Valaistusmuutostöitä</span>
                                            </label>
                                        </div>
                                        <div class="flex items-center gap-3 mb-3">
                                            <label class="inline-flex items-center gap-2 cursor-pointer">
                                                ...
                                                <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                                <span class="text-[#586B74]">Ryhmäkeskustasoisia sähkötöitä</span>
                                            </label>
                                        </div>
                                        <div class="flex items-center gap-3 mb-3">
                                            <label class="inline-flex items-center gap-2 cursor-pointer">
                                                ...
                                                <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                                <span class="text-[#586B74]">Pääkeskustasoisia sähkötöitä</span>
                                            </label>
                                        </div>
                                        <div class="flex items-center gap-3 mb-3">
                                            <label class="inline-flex items-center gap-2 cursor-pointer">
                                                ...
                                                <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                                <span class="text-[#586B74]">LVI-töitä</span>
                                            </label>
                                        </div>
                                        <div class="flex items-center gap-3 mb-3">
                                            <label class="inline-flex items-center gap-2 cursor-pointer">
                                                ...
                                                <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                                <span class="text-[#586B74]">Automaatiotöitä</span>
                                            </label>
                                        </div>
                                        <div class="flex items-center gap-3 mb-3">
                                            <label class="inline-flex items-center gap-2 cursor-pointer">
                                                ...
                                                <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                                <span class="text-[#586B74]">SPR-töitä</span>
                                            </label>
                                        </div>
                                        <div class="flex items-center gap-3 mb-3">
                                            <label class="inline-flex items-center gap-2 cursor-pointer">
                                                ...
                                                <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                                <span class="text-[#586B74]">Töitä vesikatolla</span>
                                            </label>
                                        </div>
                                        <div class="flex items-center gap-3 mb-3">
                                            <label class="inline-flex items-center gap-2 cursor-pointer">
                                                ...
                                                <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                                <span class="text-[#586B74]">Töitä korkealla tai tekniikkakuiluissa</span>
                                            </label>
                                        </div>
                                        <div class="flex items-center gap-3 mb-3">
                                            <label class="inline-flex items-center gap-2 cursor-pointer">
                                                ...
                                                <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                                <span class="text-[#586B74]">Töitä useassa tasossa/muun toiminnan yläpuolella</span>
                                            </label>
                                        </div>
                                        <div class="flex items-center gap-3 mb-3">
                                            <label class="inline-flex items-center gap-2 cursor-pointer">
                                                ...
                                                <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                                <span class="text-[#586B74]">Töitä vilkkaasti liikennöidyllä paikalla</span>
                                            </label>
                                        </div>
                                        <div class="flex items-center gap-3 mb-3">
                                            <label class="inline-flex items-center gap-2 cursor-pointer">
                                                ...
                                                <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                                <span class="text-[#586B74]">Töitä käytössä olevassa kiinteistössä</span>
                                            </label>
                                        </div>
                                        <div class="flex items-center gap-3 mb-3">
                                            <label class="inline-flex items-center gap-2 cursor-pointer">
                                                ...
                                                <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                                <span class="text-[#586B74]">Töitä käytössä olevassa tilassa</span>
                                            </label>
                                        </div>
                                        <div class="flex items-center gap-3 mb-3">
                                            <label class="inline-flex items-center gap-2 cursor-pointer">
                                                ...
                                                <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                                <input type="text" name="pilar_filed8_6" placeholder="(Tähän oma)" class="flex-1 w-full shadow-[0_0_5px_2px_rgb(81,244,200,44%)] border border-solid border-[#06F9B7] rounded-[5px] p-2">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="flex items-center mb-5">
                                    <span class="text-[#586B74] text-[17px] w-[35%]">Rakennuttaja:</span>
                                    <span class="text-[#00B2A9] italic">T1</span>
                                </div>
                                <div class="flex items-center mb-5">
                                    <span class="text-[#586B74] text-[17px] w-[35%]">Päätoteuttaja:</span>
                        ...
                        <div class="max-w-[700px] mx-auto">
                            ...
                            <p class="text-[#586B74] text-[17px] my-5">Kohteelle tyypillisiä ominaisuuksia ja olosuhteita ovat mm.</p>
                            ...
                            <div>
                                <label class="mb-5 flex items-start gap-2 cursor-pointer">
                                    ...
                                    <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                    <span class="text-[#586B74] flex-1 mt-[-5px]">Työt toteutetaan toiminnassa olevassa kiinteistössä. Muutosalueen ympäröivissä tiloissa on ulkopuolisia kiinteistön käyttäjiä.</span>
                                </label>
                                <label class="mb-5 flex items-start gap-2 cursor-pointer">
                                    <span class="shadow-[0_0_4px_2px_rgb(81,244,200,44%)] border border-solid border-[#06F9B7] w-[18px] h-[18px] rounded-[4px] inline-flex items-center justify-center">
                                        <svg class="check_show hidden" width="12px" height="12px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M4 12.6111L8.92308 17.5L20 6.5" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                                    ...
                                    <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                    <span class="text-[#586B74] flex-1 mt-[-5px]">Työt toteutetaan vilkkaasti liikennöidyllä keskusta-alueella sijaitsevassa kiinteistössä.</span>
                                </label>
                                <label class="mb-5 flex items-start gap-2 cursor-pointer">
                                    <span class="shadow-[0_0_4px_2px_rgb(81,244,200,44%)] border border-solid border-[#06F9B7] w-[18px] h-[18px] rounded-[4px] inline-flex items-center justify-center">
                                        <svg class="check_show hidden" width="12px" height="12px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M4 12.6111L8.92308 17.5L20 6.5" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                                    ...
                                    <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                    <span class="text-[#586B74] flex-1 mt-[-5px]">Rakennuksen kaikkia asennuksia, ml. kaapeleita, putkia ja johtoja ei ole kaikilta osin esitetty suunnitelmissa, joten suunnittelun ja toteutuksen lähtötiedot eivät ole kaiken kattavia.</span>
                                </label>
                                <label class="mb-5 flex items-start gap-2 cursor-pointer">
                                    <span class="shadow-[0_0_4px_2px_rgb(81,244,200,44%)] border border-solid border-[#06F9B7] w-[18px] h-[18px] rounded-[4px] inline-flex items-center justify-center">
                                        <svg class="check_show hidden" width="12px" height="12px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M4 12.6111L8.92308 17.5L20 6.5" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                                    ...
                                    <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                    <span class="text-[#586B74] flex-1 mt-[-5px]">Kaikista kiinteistössä käytetyistä rakennusmateriaaleista ei ole haitta-ainekartoitusta tai muuta tietoa.</span>
                                </label>
                                <label class="mb-5 flex items-start gap-2 cursor-pointer">
                                    <span class="shadow-[0_0_4px_2px_rgb(81,244,200,44%)] border border-solid border-[#06F9B7] w-[18px] h-[18px] rounded-[4px] inline-flex items-center justify-center">
                                        <svg class="check_show hidden" width="12px" height="12px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M4 12.6111L8.92308 17.5L20 6.5" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                                    ...
                                    <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                    <span class="text-[#586B74] flex-1 mt-[-5px]">Urakka-alueen läpi kulkee muita tiloja palvelevaa talotekniikkaa.</span>
                                </label>
                                <label class="mb-5 flex items-start gap-2 cursor-pointer">
                                    <span class="shadow-[0_0_4px_2px_rgb(81,244,200,44%)] border border-solid border-[#06F9B7] w-[18px] h-[18px] rounded-[4px] inline-flex items-center justify-center">
                                        <svg class="check_show hidden" width="12px" height="12px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M4 12.6111L8.92308 17.5L20 6.5" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                                    ...
                                    <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                    <span class="text-[#586B74] flex-1 mt-[-5px]">Kuljetus- ja haalausreitit ovat myös kiinteistön käyttäjien käytössä, mikä täytyy ottaa huomioon työmaasuunnitelmaa laadittaessa.</span>
                                </label>
                                <label class="mb-5 flex items-start gap-2 cursor-pointer">
                                    <span class="shadow-[0_0_4px_2px_rgb(81,244,200,44%)] border border-solid border-[#06F9B7] w-[18px] h-[18px] rounded-[4px] inline-flex items-center justify-center">
                                        <svg class="check_show hidden" width="12px" height="12px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M4 12.6111L8.92308 17.5L20 6.5" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                                    ...
                                    <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                    <span class="text-[#586B74] flex-1 mt-[-5px]">Työt toteutetaan säälle alttiilla paikalla ja sääolosuhteet voivat vaihdella (sade, tuuli, pakkanen, helle).</span>
                                </label>
                                <label class="mb-5 flex items-start gap-2 cursor-pointer">
                                    <span class="shadow-[0_0_4px_2px_rgb(81,244,200,44%)] border border-solid border-[#06F9B7] w-[18px] h-[18px] rounded-[4px] inline-flex items-center justify-center">
                                        <svg class="check_show hidden" width="12px" height="12px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M4 12.6111L8.92308 17.5L20 6.5" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                                    ...
                                    <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                    <span class="text-[#586B74] flex-1 mt-[-5px]">Työmaa-alueelle varattavalle tilalle on rajoitteita.</span>
                                </label>
                                <label class="mb-5 flex items-start gap-2 cursor-pointer">
                                    <span class="shadow-[0_0_4px_2px_rgb(81,244,200,44%)] border border-solid border-[#06F9B7] w-[18px] h-[18px] rounded-[4px] inline-flex items-center justify-center">
                                        <svg class="check_show hidden" width="12px" height="12px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M4 12.6111L8.92308 17.5L20 6.5" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                                    ...
                                    <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                    <span class="text-[#586B74] flex-1 mt-[-5px]">Työmaa-alueen läpi/ali kulkee satunnaisesti ulkopuolisia henkilöitä.</span>
                                </label>
                                <label class="mb-5 flex items-start gap-2 cursor-pointer">
                                    <span class="shadow-[0_0_4px_2px_rgb(81,244,200,44%)] border border-solid border-[#06F9B7] w-[18px] h-[18px] rounded-[4px] inline-flex items-center justify-center">
                                        <svg class="check_show hidden" width="12px" height="12px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M4 12.6111L8.92308 17.5L20 6.5" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                                    ...
                                    <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                    <span class="text-[#586B74] flex-1 mt-[-5px]">Työskentely tapahtuu korkealla/telineillä.</span>
                                </label>
                                <label class="mb-5 flex items-start gap-2 cursor-pointer">
                                    <span class="shadow-[0_0_4px_2px_rgb(81,244,200,44%)] border border-solid border-[#06F9B7] w-[18px] h-[18px] rounded-[4px] inline-flex items-center justify-center">
                                        <svg class="check_show hidden" width="12px" height="12px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M4 12.6111L8.92308 17.5L20 6.5" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                                    ...
                                    <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                    <span class="text-[#586B74] flex-1 mt-[-5px]">Työskentelyä tapahtuu kuiluissa.</span>
                                </label>
                                <label class="mb-5 flex items-start gap-2 cursor-pointer">
                                    <span class="shadow-[0_0_4px_2px_rgb(81,244,200,44%)] border border-solid border-[#06F9B7] w-[18px] h-[18px] rounded-[4px] inline-flex items-center justify-center">
                                        <svg class="check_show hidden" width="12px" height="12px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M4 12.6111L8.92308 17.5L20 6.5" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                                    ...
                                    <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                    <span class="text-[#586B74] flex-1 mt-[-5px]">Rakennus sisältää asbestia ja/tai muita haitta-aineita sisältäviä rakennusosia.</span>
                                </label>
                                <div class="flex items-center gap-3 mb-3">
                                    <label class="inline-flex items-center gap-2 cursor-pointer">
                                        <span class="shadow-[0_0_4px_2px_rgb(81,244,200,44%)] border border-solid border-[#06F9B7] w-[18px] h-[18px] rounded-[4px] inline-flex items-center justify-center">
                        ...
                        <div class="help_wrap mb-5 relative">
                            <div class="max-w-[700px] mx-auto flex items-center gap-2">
                                <p class="text-[#586B74] text-[17px] my-5 min-w-[480px]">Kohteelle tyypillisiä työturvallisuusriskejä ja muita riskejä sisältäviä työvaiheita tai olosuhteita ovat mm.</p>
                        ...
                        <div class="max-w-[700px] mx-auto">
                            <label class="mb-5 flex items-start gap-2 cursor-pointer">
                                ...
                                <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                <span class="text-[#586B74] flex-1 mt-[-5px]">Purkutyöt yleisesti. Purkutöitä tehtäessä purku- ja työalueiden tulee tehdä sähköstä jännitteettömiksi huomioiden kuitenkin muita käyttäjiä remontin aikana palveleva tekniikka.</span>
                            </label>
                            <label class="mb-5 flex items-start gap-2 cursor-pointer">
                                <span class="shadow-[0_0_4px_2px_rgb(81,244,200,44%)] border border-solid border-[#06F9B7] w-[18px] h-[18px] rounded-[4px] inline-flex items-center justify-center">
                                    <svg class="check_show hidden" width="12px" height="12px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M4 12.6111L8.92308 17.5L20 6.5" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                                ...
                                <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                <span class="text-[#586B74] flex-1 mt-[-5px]">Talotekniikan muutokset/lisäykset kuiluissa ja/tai korkealla työskentely; Riskinä materiaalin ja henkilöiden putoaminen kuiluun/korkealta.</span>
                            </label>
                            <label class="mb-5 flex items-start gap-2 cursor-pointer">
                                <span class="shadow-[0_0_4px_2px_rgb(81,244,200,44%)] border border-solid border-[#06F9B7] w-[18px] h-[18px] rounded-[4px] inline-flex items-center justify-center">
                                    <svg class="check_show hidden" width="12px" height="12px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M4 12.6111L8.92308 17.5L20 6.5" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                                ...
                                <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                <span class="text-[#586B74] flex-1 mt-[-5px]">Purku- ja työalueilla olevat muita kiinteistön käytössä olevia osia palvelevat kaapeloinnit. Riskinä turvallisuuden ja toimintojen häiriintyminen kiinteistön käytössä olevissa tiloissa.</span>
                            </label>
                            <label class="mb-5 flex items-start gap-2 cursor-pointer">
                                <span class="shadow-[0_0_4px_2px_rgb(81,244,200,44%)] border border-solid border-[#06F9B7] w-[18px] h-[18px] rounded-[4px] inline-flex items-center justify-center">
                                    <svg class="check_show hidden" width="12px" height="12px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M4 12.6111L8.92308 17.5L20 6.5" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                                ...
                                <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                <span class="text-[#586B74] flex-1 mt-[-5px]">Purkutyöt mahdollisten sprinklerilinjojen ja muiden paineellisten putkien läheisyydessä. Riskinä on vaurioitumisesta johtuva vesivahinko. Työt on suoritettava huolellisesti ja varmistettava, ettei vaurioita tapahdu.</span>
                            </label>
                            <label class="mb-5 flex items-start gap-2 cursor-pointer">
                                <span class="shadow-[0_0_4px_2px_rgb(81,244,200,44%)] border border-solid border-[#06F9B7] w-[18px] h-[18px] rounded-[4px] inline-flex items-center justify-center">
                                    <svg class="check_show hidden" width="12px" height="12px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M4 12.6111L8.92308 17.5L20 6.5" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                                ...
                                <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                <span class="text-[#586B74] flex-1 mt-[-5px]">Osa purkutöistä on asbesti- tai haitta-ainepurkuja.</span>
                            </label>
                            <label class="mb-5 flex items-start gap-2 cursor-pointer">
                                <span class="shadow-[0_0_4px_2px_rgb(81,244,200,44%)] border border-solid border-[#06F9B7] w-[18px] h-[18px] rounded-[4px] inline-flex items-center justify-center">
                                    <svg class="check_show hidden" width="12px" height="12px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M4 12.6111L8.92308 17.5L20 6.5" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                                ...
                                <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                <span class="text-[#586B74] flex-1 mt-[-5px]">Materiaalisiirrot ja nostot työmaalla ja katualueella; riskinä esineiden ja materiaalin putoaminen, pelastus- ja kulkureittien käytön estyminen ja sivullisten loukkaantuminen.</span>
                            </label>
                            <label class="mb-5 flex items-start gap-2 cursor-pointer">
                                <span class="shadow-[0_0_4px_2px_rgb(81,244,200,44%)] border border-solid border-[#06F9B7] w-[18px] h-[18px] rounded-[4px] inline-flex items-center justify-center">
                                    <svg class="check_show hidden" width="12px" height="12px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M4 12.6111L8.92308 17.5L20 6.5" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                                ...
                                <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                <span class="text-[#586B74] flex-1 mt-[-5px]">Kulku- ja työturvallisuus; riskinä työmaan epäjärjestyksestä johtuvat tapaturmat työntekijöille tai sivullisille.</span>
                            </label>
                            <label class="mb-5 flex items-start gap-2 cursor-pointer">
                                <span class="shadow-[0_0_4px_2px_rgb(81,244,200,44%)] border border-solid border-[#06F9B7] w-[18px] h-[18px] rounded-[4px] inline-flex items-center justify-center">
                                    <svg class="check_show hidden" width="12px" height="12px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M4 12.6111L8.92308 17.5L20 6.5" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                                ...
                                <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                <span class="text-[#586B74] flex-1 mt-[-5px]">Työmaajärjestelyt; riskinä, että ulkopuoliset harhautuvat tai tunkeutuvat työmaa-alueelle, myös viikonloppuisin.</span>
                            </label>
                            <label class="mb-5 flex items-start gap-2 cursor-pointer">
                                <span class="shadow-[0_0_4px_2px_rgb(81,244,200,44%)] border border-solid border-[#06F9B7] w-[18px] h-[18px] rounded-[4px] inline-flex items-center justify-center">
                                    <svg class="check_show hidden" width="12px" height="12px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M4 12.6111L8.92308 17.5L20 6.5" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                                ...
                                <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                <span class="text-[#586B74] flex-1 mt-[-5px]">Koneiden ja laitteiden käytöstä syntyvät vaarat ja haitat (esim. pöly, melu, tärinä ja pakokaasut). Riskinä edellä mainittujen haittojen leviäminen muualle kiinteistöön.</span>
                            </label>
                            <label class="mb-5 flex items-start gap-2 cursor-pointer">
                                <span class="shadow-[0_0_4px_2px_rgb(81,244,200,44%)] border border-solid border-[#06F9B7] w-[18px] h-[18px] rounded-[4px] inline-flex items-center justify-center">
                                    <svg class="check_show hidden" width="12px" height="12px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M4 12.6111L8.92308 17.5L20 6.5" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                                ...
                                <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                <span class="text-[#586B74] flex-1 mt-[-5px]">Paloturvallisuus; riskinä tulipalon syttyminen.</span>
                            </label>
                            <label class="mb-5 flex items-start gap-2 cursor-pointer">
                                <span class="shadow-[0_0_4px_2px_rgb(81,244,200,44%)] border border-solid border-[#06F9B7] w-[18px] h-[18px] rounded-[4px] inline-flex items-center justify-center">
                                    <svg class="check_show hidden" width="12px" height="12px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M4 12.6111L8.92308 17.5L20 6.5" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                                ...
                                <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                <span class="text-[#586B74] flex-1 mt-[-5px]">Pölyn kulkeutuminen IV-kanavistoon ja muihin liiketiloihin.</span>
                            </label>
                            <label class="mb-5 flex items-start gap-2 cursor-pointer">
                                <span class="shadow-[0_0_4px_2px_rgb(81,244,200,44%)] border border-solid border-[#06F9B7] w-[18px] h-[18px] rounded-[4px] inline-flex items-center justify-center">
                                    <svg class="check_show hidden" width="12px" height="12px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M4 12.6111L8.92308 17.5L20 6.5" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                                ...
                                <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                <span class="text-[#586B74] flex-1 mt-[-5px]">Epäergonomiset työasennot ja/tai ajat.</span>
                            </label>
                            <label class="mb-5 flex items-start gap-2 cursor-pointer">
                                <span class="shadow-[0_0_4px_2px_rgb(81,244,200,44%)] border border-solid border-[#06F9B7] w-[18px] h-[18px] rounded-[4px] inline-flex items-center justify-center">
                                    <svg class="check_show hidden" width="12px" height="12px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M4 12.6111L8.92308 17.5L20 6.5" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                                ...
                                <input type="checkbox" class="checkbox_change absolute opacity-0" name="pilar_TY1">
                                <span class="text-[#586B74] flex-1 mt-[-5px]">Liian lämpimät/kylmät työskentelyolosuhteet</span>
                            </label>
                            <div class="flex items-center gap-3 mb-3">
                                <label class="inline-flex items-center gap-2 cursor-pointer">
                                    <span class="shadow-[0_0_4px_2px_rgb(81,244,200,44%)] border border-solid border-[#06F9B7] w-[18px] h-[18px] rounded-[4px] inline-flex items-center justify-center">
                        ...
                        <div class="max-w-[700px] mx-auto">
                            ...
                            <div class="help_wrap relative">
                                <div class="flex items-center gap-2">
                                    <p class="text-[#586B74] flex items-center gap-4">
                                        <span>-</span>
                                        <span class="inline-flex items-center gap-2">
                                            Tilaaja edellyttää työssä hyvää turvallisuustasoa (TR-mittaus > 
                                            <input type="text" name="pilar_filed8_6" placeholder="90" class="flex-1 w-[80px] shadow-[0_0_5px_2px_rgb(81,244,200,44%)] border border-solid border-[#06F9B7] rounded-[5px] p-2">
                                            %)
                                        </span>
                                    </p>
                            ...
                            <p class="text-[#586B74] flex items-start gap-4 mt-5">
                                <span>-</span>
                            ...
                            <p class="text-[#586B74] my-5">Töiden yhteensovitus ja työsuojelu:</p>
                            <p class="text-[#586B74] flex items-start gap-4 mt-5">
                                <span>-</span>
                            ...
                            <p class="text-[#586B74] my-5">Turvallisuussuunnitelmien käsittely:</p>
                            <p class="text-[#586B74] flex items-start gap-4 mt-5">
                                <span>-</span>
                            ...
                            <ul class="list-disc ml-[60px]">
                                <li class="text-[#586B74]">Rakennuttajan antamat turvallisuustiedot ja -vaatimukset</li>
                                <li class="text-[#586B74]">Rakennuttajan turvallisuusasiakirjan tiedot</li>
                                <li class="text-[#586B74]">Työn ja työkohteen muut erityisolosuhteet</li>
                                <li class="text-[#586B74]">Työsuojelumääräysten mukaiset vaatimukset</li>
                            </ul>
                            <p class="text-[#586B74] flex items-start gap-4 mt-5">
                                <span>-</span>
                            ...
                            <p class="text-[#586B74] my-5">Perehdyttäminen ja työhön opastus</p>
                            <p class="text-[#586B74] flex items-start gap-4 mt-5">
                                <span>-</span>
                            ...
                            <p class="text-[#586B74] my-5">Käyttäjien huomiointi</p>
                            <p class="text-[#586B74] flex items-start gap-4 mt-5">
                                <span>-</span>
                            ...
                            <p class="text-[#586B74] my-5">Ilmoitusmenettelyt ja erityisohjeet:</p>
                            <p class="text-[#586B74] flex items-start gap-4 mt-5">
                                <span>-</span>
                            ...
                            <p class="text-[#586B74] my-5">Jakelukatkokset:</p>
                            <p class="text-[#586B74] flex items-start gap-4 mt-5">
                                <span>-</span>
                            ...
                            <p class="text-[#586B74] my-5">Aikarajoitukset:</p>
                            <p class="text-[#586B74] flex items-start gap-4 mt-5">
                                <span>-</span>
                            ...
                            <p class="text-[#586B74] my-5">Kulkurajoitukset:</p>
                            <p class="text-[#586B74] flex items-start gap-4 mt-5">
                                <span>-</span>
                        ...
                        <div class="help_wrap relative">
                            <div class="max-w-[700px] mx-auto flex items-center gap-2">
                                <p class="text-[#586B74] min-w-[310px]">
                                    Kiinteistö on valmistunut vuonna <span class="text-[#00B2A9] italic">K5</span>, jolloin
                                </p>
                            ...
                            <div class="help_show text-[#586B74] text-[14px] lg:w-[384px] bg-[#F6F8FF] border border-solid border-[#E1E1EA] rounded-lg p-5 lg:absolute lg:right-[-20px] mt-[10px] mb-[15px] lg:mb[0] lg:mt-[-50px] hidden">
                        ...
                        <div class="max-w-[700px] mx-auto">
                            ...
                            <p class="text-[#586B74] my-5">Rakennusvälineet:</p>
                            <p class="text-[#586B74] flex items-start gap-4 mt-5">
                                <span>-</span>
                                <span>Urakoitsija vastaa käyttämiensä välineiden, koneiden ja laitteiden turvallisuudesta.</span>
                            </p>

                            <p class="text-[#586B74] my-5">Ärsyttävät ja haitalliset aineet:</p>
                            <p class="text-[#586B74] flex items-start gap-4 mt-5">
                                <span>-</span>
                            ...
                            <p class="text-[#586B74] my-5">Paloturvallisuus:</p>
                            <p class="text-[#586B74] flex items-start gap-4 mt-5">
                                <span>-</span>
                            ...
                            <p class="text-[#586B74] my-5">Pölyn leviäminen:</p>
                            <p class="text-[#586B74] flex items-start gap-4 mt-5">
                                <span>-</span>
                            ...
                            <p class="text-[#586B74] my-5">Melun ja tärinän rajoittaminen:</p>
                            <p class="text-[#586B74] flex items-start gap-4 mt-5">
                                <span>-</span>
                            ...
                            <p class="text-[#586B74] my-5">Henkilökohtaiset suojavarusteet ja vaatimukset:</p>
                            <p class="text-[#586B74] flex items-start gap-4 mt-5">
                                <span>-</span>
                            ...
                            <p class="text-[#586B74] my-5">Työhygieeniset mittaukset:</p>
                            <p class="text-[#586B74] flex items-start gap-4 mt-5">
                                <span>-</span>
                            ...
                            <p class="text-[#586B74] my-5">Kulkureitit ja poistumistiet:</p>
                            <p class="text-[#586B74] flex items-start gap-4 mt-5">
                                <span>-</span>
                            ...
                            <p class="text-[#586B74] my-5">Tupakointi:</p>
                            <p class="text-[#586B74] flex items-start gap-4 mt-5">
                                <span>-</span>
                            ...
                            <p class="text-[#586B74] my-5">Sähkön jakelu:</p>
                            <p class="text-[#586B74] flex items-start gap-4 mt-5">
                                <span>-</span>
                            ...
                            <p class="text-[#586B74] my-5">Sähkölaitteiden turvallisuus:</p>
                            <p class="text-[#586B74] flex items-start gap-4 mt-5">
                                <span>-</span>
                            ...
                            <p class="text-[#586B74] my-5">Työalueen läpi menevät asennukset ja niiden häiriöttömyys:</p>
                            <p class="text-[#586B74] flex items-start gap-4 mt-5">
                                <span>-</span>
                            ...
                            <p class="text-[#586B74] my-5">Ilmanvaihto:</p>
                            <p class="text-[#586B74] flex items-start gap-4 mt-5">
                                <span>-</span>
                            ...
                            <h4 class="text-[17px] text-[#586B74] mt-10 mb-5">LIITTEET</h4>
                            <div class="flex items-center gap-3 mb-3">
                                <label class="inline-flex items-center gap-2 cursor-pointer">
                                    <span class="shadow-[0_0_4px_2px_rgb(81,244,200,44%)] border border-solid border-[#06F9B7] w-[18px] h-[18px] rounded-[4px] inline-flex items-center justify-center">
                                        <svg class="check_show hidden" width="12px" height="12px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M4 12.6111L8.92308 17.5L20 6.5" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
