                    ...
                    <div class="px-4 md:px-8 pt-6 pb-10 lg:h-[645px] overflow-y-auto no-scrollbar scroll-smooth">
                        <div class="max-w-[700px] mx-auto mt-20">
                            ...
                            <div class="mb-[30px]">
                                ...
                                <input type="text" <?php noste_textinput_attrset('noste_VA_1'); ?> placeholder="XX.XX.XXXX" class="shadow-[0_0_5px_2px_rgb(81,244,200,44%)] min-w-full  lg:min-w-[209px] border border-solid border-[#06F9B7] rounded-[5px] p-2">
                            </div>
                            ...
                            <div>
                                <div class="flex flex-col lg:flex-row lg:items-center gap-3">
                                    ...
                                    <input type="text" <?php noste_textinput_attrset('noste_filed8_6_4'); ?> class="flex-1 w-full shadow-[0_0_5px_2px_rgb(81,244,200,44%)] border border-solid border-[#06F9B7] rounded-[5px] p-2">
                                </div>
                        ...
                        <div class="max-w-[700px] mx-auto mt-8">
                            ...
                            <div class="flex flex-col lg:flex-row lg:items-center gap-2">
                                ...
                                <span>
                                    <input type="text" <?php noste_textinput_attrset('noste_VA_2'); ?> placeholder="XX.XX.XXXX" class="w-full lg:w-[119px] shadow-[0_0_5px_2px_rgb(81,244,200,44%)]  border border-solid border-[#06F9B7] rounded-[5px] p-2">
                                </span>
                            ...
                            <div class="flex flex-col lg:flex-row lg:items-center gap-2 mt-10">
                                ...
                                <span class="">
                                    <input type="text" <?php noste_textinput_attrset('noste_VA_3'); ?> placeholder="XX.XX.XXXX" class="w-full lg:w-[119px] shadow-[0_0_5px_2px_rgb(81,244,200,44%)]  border border-solid border-[#06F9B7] rounded-[5px] p-2">
                                </span>
                                <span class="flex-1 text-[#586B74] text-[15px]">klo</span>
                                <span class="">
                                    <input type="text" <?php noste_textinput_attrset('noste_VA_4'); ?> placeholder="XX.XX.XXXX" class="w-full lg:w-[68px] shadow-[0_0_5px_2px_rgb(81,244,200,44%)]  border border-solid border-[#06F9B7] rounded-[5px] p-2">
                                </span>
                            ...
                            <div>
                                ...
                                <div class="grid lg:grid-cols-3 items-center gap-[20px] mb-5">
                                    ...
                                    <span class="text-[#586B74]">
                                        <input type="text" <?php noste_textinput_attrset('noste_VA_5'); ?> placeholder="XX.XX.XXXX" class="w-full lg:w-[119px] shadow-[0_0_5px_2px_rgb(81,244,200,44%)]  border border-solid border-[#06F9B7] rounded-[5px] p-2">
                                    </span>
                                </div>
                                <div class="grid lg:grid-cols-3 items-center gap-[20px] mb-5">
                                    ...
                                    <span class="text-[#586B74]">Partners at Noste Oy</span>
                                    <span class="text-[#586B74]">
                                        <input type="text" <?php noste_textinput_attrset('noste_VA_6'); ?> placeholder="XX.XX.XXXX" class="w-full lg:w-[119px] shadow-[0_0_5px_2px_rgb(81,244,200,44%)]  border border-solid border-[#06F9B7] rounded-[5px] p-2">
                                    </span>
                                </div>
                                <div class="grid lg:grid-cols-3 items-center gap-[20px] mb-5">
                                    ...
                                    <span class="text-[#586B74]">Partners at Noste Oy</span>
                                    <span class="text-[#586B74]">
                                        <input type="text" <?php noste_textinput_attrset('noste_VA_7'); ?> placeholder="XX.XX.XXXX" class="w-full lg:w-[119px] shadow-[0_0_5px_2px_rgb(81,244,200,44%)]  border border-solid border-[#06F9B7] rounded-[5px] p-2">
                                    </span>
                                </div>
                                <div class="grid lg:grid-cols-3 items-center gap-[20px] mb-5">
                                    ...
                                    <span class="text-[#586B74]">Partners at Noste Oy</span>
                                    <span class="text-[#586B74]">
                                        <input type="text" <?php noste_textinput_attrset('noste_VA_8'); ?> placeholder="XX.XX.XXXX" class="w-full lg:w-[119px] shadow-[0_0_5px_2px_rgb(81,244,200,44%)]  border border-solid border-[#06F9B7] rounded-[5px] p-2">
                                    </span>
                                </div>
                                <div class="grid lg:grid-cols-3 items-center gap-[20px] mb-5">
                                    <span class="text-[#586B74]">
                                    ...
                                    <span class="text-[#586B74]">
                                        <input type="text" <?php noste_textinput_attrset('noste_VA_9'); ?> placeholder="XX.XX.XXXX" class="w-full lg:w-[119px] shadow-[0_0_5px_2px_rgb(81,244,200,44%)]  border border-solid border-[#06F9B7] rounded-[5px] p-2">
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="mt-10">
                                ...
                                <div class="grid lg:grid-cols-3 items-center gap-[20px] mb-5">
                                    ...
                                    <span class="text-[#586B74]"><span class="flex-1 h-[1px] bg-[#94969C] inline-block w-full"></span></span>
                                    <span class="text-[#586B74]">
                                        <input type="text" <?php noste_textinput_attrset('noste_VA_10'); ?> placeholder="XX.XX.XXXX" class="w-full lg:w-[119px] shadow-[0_0_5px_2px_rgb(81,244,200,44%)]  border border-solid border-[#06F9B7] rounded-[5px] p-2">
                                    </span>
                                </div>
                                <div class="grid lg:grid-cols-3 items-center gap-[20px] mb-5">
                                    <span class="text-[#586B74]">
                                    ...
                                    <span class="text-[#586B74]">Partners at Noste Oy</span>
                                    <span class="text-[#586B74]">
                                        <input type="text" <?php noste_textinput_attrset('noste_VA_11'); ?> placeholder="XX.XX.XXXX" class="w-full lg:w-[119px] shadow-[0_0_5px_2px_rgb(81,244,200,44%)]  border border-solid border-[#06F9B7] rounded-[5px] p-2">
                                    </span>
                                </div>
                                <div class="grid lg:grid-cols-3 items-center gap-[20px] mb-5">
                                    <span class="text-[#586B74]">
