<?php 
	...
	$tm_inner = [
		'muutostyoesitykset' => [
			...
			'status' => !empty($project_intdata['muutostyoesitykset']['status']) ? $project_intdata['muutostyoesitykset']['status'] : 0,
			'url' => '',
			'comment' => !empty($project_intdata['muutostyoesitykset']['comment']) ? $project_intdata['muutostyoesitykset']['comment'] : '',
		],
		'lmt' => [
			'title' => 'Selvitä kuka on kustannusvastuussa LMT:stä ja hyväksytä se hänellä',
			'status' => !empty($project_intdata['lmt']['status']) ? $project_intdata['lmt']['status'] : 0,
			'url' => '',
			'comment' => !empty($project_intdata['lmt']['comment']) ? $project_intdata['lmt']['comment'] : '',
		],
		'kustannusseurantaan' => [
			'title' => 'Lisää LMT-aihe kustannusseurantaan',
			'status' => !empty($project_intdata['kustannusseurantaan']['status']) ? $project_intdata['kustannusseurantaan']['status'] : 0,
			'url' => [
				'link'	=> '',
				'title'	=> 'Kustannusseurantakuvake löytyy projektin ylävalikosta'
			],
			'comment' => !empty($project_intdata['kustannusseurantaan']['comment']) ? $project_intdata['kustannusseurantaan']['comment'] : '',
		],
		'ajantasaista' => [
			'title' => 'Huolehdi, että urakoitsija pitää ajantasaista lisä- ja muutostyökoontilistaa',
			'status' => !empty($project_intdata['ajantasaista']['status']) ? $project_intdata['ajantasaista']['status'] : 0,
			'url' => '',
			'comment' => !empty($project_intdata['ajantasaista']['comment']) ? $project_intdata['ajantasaista']['comment'] : '',
		],
	];
