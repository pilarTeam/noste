                    ...
                    <div class="px-4 md:px-8 pt-6 pb-10 lg:h-[645px] overflow-y-auto no-scrollbar scroll-smooth"> 
                        ...
                        <table class="w-full whitespace-wrap border-collapse">
                            <thead class="text-left rounded-t-lg bg-accent text-white">
                                <tr class="rounded-lg">
                                    <th class="p-3 min-w-[14rem]">Toimenpiteet</th>
                                    <th class="p-3 min-w-[10rem]">Määrä</th>
                                    <th class="p-3 min-w-[5rem]">Yksikköhinta</th>
                                    <th class="p-3 min-w-[8rem]">Hinta (alv 0%)</th>
                                    <th class="p-3 min-w-[6rem]"></th>
                                </tr>
                            </thead>
                            <tbody>
                                    ...
                                    <td class="px-4 py-3 border border-line">
                                        <div class="flex items-center gap-3">
                                            <label class="inline-flex items-center gap-2 cursor-pointer">
                                                ...
                                                <input type="checkbox" class="checkbox_change absolute opacity-0" <?php noste_checkbox_attrset('pilar_filed2_1', $data); ?>>
                                            </label>
                                            <input type="text" <?php noste_textinput_attrset('pilar_filed8_2', $data); ?> class="shadow-input w-[100%] border border-solid border-[#06F9B7] rounded-[5px] p-2" placeholder="Osa-alueet eriteltynä">
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-4 py-3 border border-line">
                                        <div class="flex items-center gap-3">
                                            <label class="inline-flex items-center gap-2 cursor-pointer">
                                                ...
                                                <input type="checkbox" class="checkbox_change absolute opacity-0" <?php noste_checkbox_attrset('pilar_filed2_2', $data); ?>>
                                            </label>
                                            <input type="text" <?php noste_textinput_attrset('pilar_filed8_5', $data); ?> class="shadow-input w-[100%] border border-solid border-[#06F9B7] rounded-[5px] p-2" placeholder="Osa-alueet eriteltynä">
                                        </div>
                                    </td>
                                    <td class="px-4 py-3 border border-line text-sm">
                                        <div class="flex items-center border border-solid border-accent shadow-input rounded-lg">
                                    ...
                                    <td class="px-4 py-3 border border-line">
                                        <div class="flex items-center gap-3">
                                            <label class="inline-flex items-center gap-2 cursor-pointer">
                                                ...
                                                <input type="checkbox" class="checkbox_change absolute opacity-0" <?php noste_checkbox_attrset('pilar_filed2_3', $data); ?>>
                                            </label>
                                            <input type="text" <?php noste_textinput_attrset('pilar_filed8_7', $data); ?> class="shadow-input w-[100%] border border-solid border-[#06F9B7] rounded-[5px] p-2" placeholder="Osa-alueet eriteltynä">
                                        </div>
                                    </td>
                                    <td class="px-4 py-3 border border-line text-sm">
                                        <div class="flex items-center border border-solid border-accent shadow-input rounded-lg">
                                ...
                                <tr>
                                    <td class="px-4 py-3 border border-line  w-56">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <input type="text" <?php noste_textinput_attrset('pilar_filed8_10', $data); ?> class="shadow-input w-[100%] border border-solid border-[#06F9B7] rounded-[5px] p-2" placeholder="Osa-alueet eriteltynä">
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-4 py-3 border border-line">
                                        <div class="flex items-center gap-3">
                                            <label class="inline-flex items-center gap-2 cursor-pointer">
                                                ...
                                                <input type="checkbox" class="checkbox_change absolute opacity-0" <?php noste_checkbox_attrset('pilar_filed2_5', $data); ?>>
                                            </label>
                                            <input type="text" <?php noste_textinput_attrset('pilar_filed8_13', $data); ?> class="shadow-input w-[100%] border border-solid border-[#06F9B7] rounded-[5px] p-2" placeholder="Osa-alueet eriteltynä">
                                        </div>
                                    </td>
                                    <td class="px-4 py-3 border border-line text-sm" id="project_table_status">
                                        <div class="flex items-center border border-solid border-accent shadow-input rounded-lg">
                                    ...
                                    <td class="px-4 py-3 border border-line  w-56">
                                        <div class="flex items-center gap-3">
                                            <label class="inline-flex items-center gap-2 cursor-pointer">
                                                ...
                                                <input type="checkbox" class="checkbox_change absolute opacity-0" <?php noste_checkbox_attrset('pilar_filed2_6', $data); ?>>
                                            </label>
                                            <input type="text" <?php noste_textinput_attrset('pilar_filed8_16', $data); ?> class="shadow-input w-[100%] border border-solid border-[#06F9B7] rounded-[5px] p-2" placeholder="Osa-alueet eriteltynä">
                                        </div>
                                    </td>
                                    <td class="px-4 py-3 border border-line text-sm">
                                        <div class="flex items-center border border-solid border-accent shadow-input rounded-lg">
                                    ...
                                    <td class="px-4 py-3 border border-line">
                                        <div class="flex items-center gap-3">
                                            <label class="inline-flex items-center gap-2 cursor-pointer">
                                                ...
                                                <input type="checkbox" class="checkbox_change absolute opacity-0" <?php noste_checkbox_attrset('pilar_filed2_7', $data); ?>>
                                            </label>
                                            <input type="text" <?php noste_textinput_attrset('pilar_filed8_19', $data); ?> class="shadow-input w-[100%] border border-solid border-[#06F9B7] rounded-[5px] p-2" placeholder="Osa-alueet eriteltynä">
                                        </div>
                                    </td>
                                    <td class="px-4 py-3 border border-line text-sm">
                                        <div class="flex items-center border border-solid border-accent shadow-input rounded-lg">
                                ...
                                <tr>
                                    <td colspan="5" class="px-4 py-3 border border-line">
                                        <h4 class="text-normal italic text-accent">TY12</h4>
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <div class="help_wrap mb-8 relative">
                        <div class="max-w-[800px] mx-auto flex items-center gap-2">
                            <div class="w-full border border-line">
                                ...
                                <div class="p-4">
                                    <textarea class="shadow-input text-sm border-accent rounded-md text-black order-3 w-full" rows="4" name="huomiot"></textarea>
                                </div>
                            </div>
