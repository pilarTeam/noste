        ...
        <div class="grid grid-cols-1">
            ...
            <div class="card_item relative h-fit">
                ...
                <div class="px-4 md:px-8 pt-6 pb-10 lg:h-[645px] overflow-y-auto no-scrollbar scroll-smooth">
                    <h1 class="text-lg text-dark mb-4">Kustannusarvion ja aikataulun päivitys</h1>

                    <p class="text-base text-[#475467] mb-4">
                        <b>Sisältö:</b><br>
                        Tarkennetaan kustannusarvio kohdekäynnin ja vuokrausneuvottelujen kommenttien perusteella. Tarkennetaan aikataulu ja lukitaan valmistumisajankohta sekä hallinnanluovutusajankohta vuokrasopimukseen. <br><br>
                        <b>Kuvaus:</b><br>
