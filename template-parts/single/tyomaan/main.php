<?php 
    ...
    $tm_inner = [
        ...
        'kay_lapi' => [
            ...
            'status' => !empty($project_intdata['kay_lapi']['status']) ? $project_intdata['kay_lapi']['status'] : 0,
            'url' => '',
            'comment' => !empty($project_intdata['kay_lapi']['comment']) ? $project_intdata['kay_lapi']['comment'] : '',
        ],
    ];
        ...
        <div class="grid grid-cols-1">
            ...
            <div class="card_item relative h-fit">
                ...
                <div class="px-4 md:px-8 pt-6 pb-10 lg:h-[645px] overflow-y-auto no-scrollbar scroll-smooth">
                    <h1 class="text-2xl text-dark mb-4">Työmaan käynnistymisen tehtävät</h1>
