            ...
            <div class="card_item relative h-fit">
                ...
                <div class="px-4 md:px-8 pt-6 pb-10 lg:h-[645px] overflow-y-auto no-scrollbar scroll-smooth">
                    ...
                    <p class="text-base text-[#475467] mb-4">
                        <b>Sisältö:</b><br>
                        Pidetään yhteyttä tilaajaan vuokrasopimuksen allekirjoitustilanteen osalta. Pidetään noste.ion sisällä resursoinnista vastaava taho tietoisena vuokralaismuutoksen aloituksen tilanteesta. <br><br>
                        <b>Kuvaus:</b><br>
