<?php 
    ...
    $tm_inner = [
        ...
        'lopullisen' => [
            ...
            'status' => !empty($project_intdata['lopullisen']['status']) ? $project_intdata['lopullisen']['status'] : 0,
            'url' => '',
            'comment' => !empty($project_intdata['lopullisen']['comment']) ? $project_intdata['lopullisen']['comment'] : '',
        ],
    ];
