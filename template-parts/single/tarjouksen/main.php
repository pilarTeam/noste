<?php 
    ...
    $tm_inner = [
        'urakkatarjousvertailu' => [
            ...
            'status' => !empty($project_intdata['urakkatarjousvertailu']['status']) ? $project_intdata['urakkatarjousvertailu']['status'] : 0,
            'url' => [
                'link'    => 'urakkatarjousvertailu',
                'title'    => 'Urakkatarjousvertailu'
            ],
            'comment' => !empty($project_intdata['urakkatarjousvertailu']['comment']) ? $project_intdata['urakkatarjousvertailu']['comment'] : '',
        ],
        'esitatilaajan' => [
            'title' => 'Esitä tilaajan hyväksyttäväksi valittava urakoitsija',
            'status' => !empty($project_intdata['esitatilaajan']['status']) ? $project_intdata['esitatilaajan']['status'] : 0,
            'url' => [
                'link'    => '',
                'title'    => 'OHJE Urakoitsijan hyväksyttäminen Tilaajalla'
            ],
            'comment' => !empty($project_intdata['esitatilaajan']['comment']) ? $project_intdata['esitatilaajan']['comment'] : '',
        ],
        'edeta' => [
            ...
            'status' => !empty($project_intdata['edeta']['status']) ? $project_intdata['edeta']['status'] : 0,
            'url' => '',
            'comment' => !empty($project_intdata['edeta']['comment']) ? $project_intdata['edeta']['comment'] : '',
        ],
    ];
