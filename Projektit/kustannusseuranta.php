                        ...
                        <table class="w-full">
                            ...
                            <tr>
                                ...
                                <td class="text-[#586B74] text-[14px] text-left p-3 border border-solid border-[#E1E1EA]">
                                    <input type="text" name="pilar_M4" value="6 200 €" class="shadow-[0_0_5px_2px_rgb(81,244,200,44%)] w-[100%] border border-solid border-[#06F9B7] rounded-[5px] p-2" value="<?php echo esc_attr( noste_check_empty( get_post_meta( $pid, 'pilar_M4', true )) ); ?>">
                                </td>
                                <td class=""></td>
                            </tr>
                        </table>
