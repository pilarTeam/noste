...
/* Template Name: Old Kustannusseuranta */
            ...
            <div>
                <div class="overflow-x-scroll lg:overflow-x-auto scroller">
                    <table class="w-full">
                        ...
                        <tr>
                            <td class="text-center font-medium p-3 border border-solid border-[#E1E1EA]"><svg width="24px" height="24px" class="mx-auto" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <circle cx="12" cy="12" r="10" stroke="#586B74" stroke-width="0.384"></circle> <path d="M15 12H9" stroke="#586B74" stroke-width="0.384" stroke-linecap="round"></path> </g></svg></td>
                            <td class="text-left text-[#00B2A9] italic font-medium p-3 border border-solid border-[#E1E1EA]"></td>
                            <td class="text-left font-medium p-3 border border-solid border-[#E1E1EA]"></td>
                            <td class="bg-[#00B2A9] text-left text-black font-medium p-3 text-[17px] border border-solid border-[#E1E1EA]">Laskunumero</td>
                            <td class="bg-[#00B2A9] text-right text-black font-medium p-3 text-[17px] border border-solid border-[#E1E1EA]">Laskun summa (alv 0%)</td>
                            <td class="text-[#586B74] text-[14px] text-left font-medium p-3 border border-solid border-[#E1E1EA]"></td>
                            <td class=""></td>
                        </tr>
                ...
                <div class="overflow-x-scroll scroller">
                    <table class="w-full">
                        <tr>
                            <td class="min-w-[70px] text-center font-medium p-3 border border-solid border-[#E1E1EA]"><svg width="24px" height="24px" class="mx-auto" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <circle cx="12" cy="12" r="10" stroke="#586B74" stroke-width="0.384"></circle> <path d="M15 12H9" stroke="#586B74" stroke-width="0.384" stroke-linecap="round"></path> </g></svg></td>
                            ...
                            <td class="min-w-[188px] bg-[#00B2A9] text-left text-white font-medium p-3 text-[18px] border border-solid border-[#E1E1EA]">Juokseva nro</td>
                            <td class="min-w-[300px] bg-[#00B2A9] text-left text-white font-medium p-3 text-[18px] border border-solid border-[#E1E1EA]">Tarjous nro</td>
                            <td class="min-w-[350px] bg-[#00B2A9] text-left text-white font-medium p-3 text-[18px] border border-solid border-[#E1E1EA]">Sisältö</td>
                            <td class="bg-[#00B2A9] text-left text-white font-medium p-3 text-[18px] border border-solid border-[#E1E1EA] min-w-[230px]">Tarjous € (alv 0%)</td>
                            <td class="bg-[#00B2A9] text-left text-white font-medium p-3 text-[18px] border border-solid border-[#E1E1EA] min-w-[230px]">Tarjous pvm.</td>
                            <td class="bg-[#00B2A9] text-left text-white font-medium p-3 text-[18px] border border-solid border-[#E1E1EA] min-w-[230px]">Käyttäjämuutos</td>
                            <td class="bg-[#00B2A9] text-left text-white font-medium p-3 text-[18px] border border-solid border-[#E1E1EA] min-w-[230px]">Hinnoitteluperuste</td>
                            <td class="bg-[#00B2A9] text-left text-white font-medium p-3 text-[18px] border border-solid border-[#E1E1EA] min-w-[230px]">Maksaja</td>
                            <td class="bg-[#00B2A9] text-left text-white font-medium p-3 text-[18px] border border-solid border-[#E1E1EA] min-w-[230px]">Lisätyö / muutostyö</td>
                            <td class="bg-[#00B2A9] text-left text-white font-medium p-3 text-[18px] border border-solid border-[#E1E1EA] min-w-[230px]">Hyväks. Käyttäjä (pvm.)</td>
                            <td class="bg-[#00B2A9] text-left text-white font-medium p-3 text-[18px] border border-solid border-[#E1E1EA] min-w-[230px]">Hyväks. Tilaaja (pvm.)</td>
                            <td class="bg-[#00B2A9] text-left text-white font-medium p-3 text-[18px] border border-solid border-[#E1E1EA] min-w-[230px]">Lisäaikavaikutus (tv)</td>
                            <td class="bg-[#00B2A9] text-left text-white font-medium p-3 text-[18px] border border-solid border-[#E1E1EA] min-w-[230px]">Laskutettu</td>
                            <td class="bg-[#00B2A9] text-left text-white font-medium p-3 text-[18px] border border-solid border-[#E1E1EA] min-w-[230px]">Lasku numero</td>
                            <td class="bg-[#00B2A9] text-left text-white font-medium p-3 text-[18px] border border-solid border-[#E1E1EA] min-w-[450px]">Huom.</td>
                        </tr>
